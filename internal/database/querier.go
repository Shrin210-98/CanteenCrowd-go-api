...
type Querier interface {
	...
	ClearOverridesForRole(ctx context.Context, arg ClearOverridesForRoleParams) error
	ClearPasswordResetToken(ctx context.Context, id uuid.UUID) (User, error)
	ClearUserPermissionsOverride(ctx context.Context, arg ClearUserPermissionsOverrideParams) (User, error)
	...
	CountUsersWithOverridesForRole(ctx context.Context, arg CountUsersWithOverridesForRoleParams) (int64, error)
	...
	GetUserWithRoleAndPermissions(ctx context.Context, arg GetUserWithRoleAndPermissionsParams) (GetUserWithRoleAndPermissionsRow, error)
	...
	GetUsersWithOverridesForRole(ctx context.Context, arg GetUsersWithOverridesForRoleParams) ([]GetUsersWithOverridesForRoleRow, error)
	GetUsersWithRoleAndOverrideStatus(ctx context.Context, arg GetUsersWithRoleAndOverrideStatusParams) ([]GetUsersWithRoleAndOverrideStatusRow, error)
	...
	UpdateUserPermissionsOverride(ctx context.Context, arg UpdateUserPermissionsOverrideParams) (User, error)
